  ...
  <mdui-card class="p-5 my-10 sm:w-80%">
    ...
    <div>
      <mdui-text-field
        ...
        @click="copyCode"
        class="max-w-lg"
        :class="{ 'blur-field': isTimeUp || isFetchFailed }"
        readonly
        label="一次性代码"
        :value="logincode"
      ...
      <div v-if="isTimeUp || isFetchFailed">
        ...
        <mdui-button
          ...
          >重新获取<mdui-icon-refresh slot="icon"></mdui-icon-refresh
        ></mdui-button>
      </div>
      <p v-else>
        ...
        actions: [
          {
            ...
            onClick: () => {
              window.open(
                'https://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=52ZKih_plrIdrn0X8OTaXnKPp9LgtqVs&authKey=yK1u5GClhphiEZ2LrERghmwXUiu%2B5K3zBYc%2FnFuYE%2FwPWYnhNIyawF1Aj26bLJZn&noverify=0&group_code=584380963'
              )
            }
          },
          {
