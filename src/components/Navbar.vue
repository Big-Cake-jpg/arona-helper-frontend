<template>
    <mdui-navigation-rail :value="value" divider>
        ...
        <mdui-button-icon @click="toggleDark()" slot="bottom" alt="切换模式"><mdui-icon-brightness-6></mdui-icon-brightness-6></mdui-button-icon>
